...
<body>
    ...
    <form method="POST" action="/projectStore"  enctype="multipart/form-data">
<a href="{{route('projectIndex')}}"><i class="fa-solid fa-arrow-left"></i></a>
   @csrf
        ...
        <div> <input class="" type="text" name="summary"  class ="form-control" placeholder="Summary"></div>
        <div> <input class="" type="text" name="banner_image"  class ="form-control" placeholder="Banner Image"></div>
        <div>  <input class="" type="date" name="date"  class ="form-control" placeholder="Date"></div>
        <div>  <input class="" type="date" name="end_date"  class ="form-control" placeholder="End_date"></div>
